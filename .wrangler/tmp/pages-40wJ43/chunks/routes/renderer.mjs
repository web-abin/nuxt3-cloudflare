globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:{}};import { w as withLeadingSlash, g as global, c as createHooks, j as joinRelativeURL, u as useRuntimeConfig, a as defineRenderHandler, b as getQuery, e as createError, f as getRouteRules, h as useNitroApp, i as getResponseStatusText, k as getResponseStatus } from '../nitro/nitro.mjs';
...
const appHead = {"meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"name":"description","content":"一个包含 3D 效果和滚动动画的交互式个人简历/作品集"}],"link":[],"style":[],"script":[],"noscript":[],"title":"交互式个人简历/作品集"};
...
export { getCurrentScope as A, useSSRContext as B, onServerPrefetch as C, ssrRenderComponent as D, renderVNode as E, createVNode as F, resolveDynamicComponent as G, mergeProps as H, defineAsyncComponent as I, ssrRenderAttrs as J, Fragment as K, ssrRenderList as L, withAsyncContext as M, ssrRenderAttr as N, ssrInterpolate as O, ssrRenderStyle as P, toValue as Q, withCtx as R, Suspense as S, Transition as T, createTextVNode as U, toDisplayString as V, resolveComponent as W, watchEffect as X, renderer$1 as Y, shallowReactive as a, ref as b, computed as c, defineComponent as d, baseURL as e, hasInjectionContext as f, getActiveHead as g, h, inject as i, getCurrentInstance as j, createApp as k, ssrRenderSuspense as l, effectScope as m, nextTick as n, onErrorCaptured as o, provide as p, isReadonly as q, reactive as r, shallowRef as s, toRef as t, unref as u, isReactive as v, watch as w, toRaw as x, isRef as y, isShallow as z };
